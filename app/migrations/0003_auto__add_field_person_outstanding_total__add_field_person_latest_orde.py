...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.outstanding_total'
        db.add_column('people', 'outstanding_total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)

        # Adding field 'Person.latest_order_date'
        db.add_column('people', 'latest_order_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.outstanding_total'
        db.delete_column('people', 'outstanding_total')

        # Deleting field 'Person.latest_order_date'
        db.delete_column('people', 'latest_order_date')
    ...
    models = {
        ...
        u'app.person': {
            ...
            'latest_order_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            ...
            'outstanding_total': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '11', 'decimal_places': '2'}),
